...
class UsuarioMapController{
  ...
  Future? init(BuildContext context, Function refresh) async{
    ...
    markerDriver = await createMarkerImageFromAsset('assets/img/icon_taxi.png');  ////ULILIZADO EN M3
    checkGPS();
  }
  ...
  void updateLocation() async {
    try {
      ...
      _position = await Geolocator.getLastKnownPosition(); // SOLO MUESTRA NUESTRA UBICACION UN ASOLA VEZ
      centerPosition();
    } catch (error) {
